...
>(
    ...
    D::Inner: crate::wrapper::controller::Controller,
{
    ...
    for controller_wrapper in wrappers {
        if controller_wrapper.register(service.context, cfu_client).is_err() {
...
pub async fn task<'a, M, D, PSU: Lockable, S, V, const N: usize>(
    ...
    S: event::Sender<power_policy_interface::psu::event::EventData>,
    V: crate::wrapper::FwOfferValidator,
    <D as embedded_services::sync::Lockable>::Inner: crate::wrapper::controller::Controller,
{
