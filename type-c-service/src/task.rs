...
pub async fn task_closure<'a, Fut: Future<Output = ()>, F: Fn(&'a Service) -> Fut>(
    service: &'static mut Service<'a>,
    f: F,
) {
    ...
    // let service = Service::create(config, ctx, power_policy_publisher, power_policy_subscriber);
