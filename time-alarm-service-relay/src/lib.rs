...
use embedded_services::relay::{MessageSerializationError, SerializableMessage}; // TODO do we want to continue using this for errors?
use time_alarm_service_interface::{
    ...
    TimeAlarmDeviceCapabilities, TimeAlarmService, TimerStatus,
};
...
// TODO relay struct
// TODO maybe move everything above this into a submodule since it's not part of the public interface
