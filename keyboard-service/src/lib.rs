...
pub trait HidKeyboard {
    ...
    fn scan(&mut self) -> impl core::future::Future<Output = &[u8]>;
    ...
    fn set_power_state(&mut self, power_state: hid::PowerState) -> impl core::future::Future<Output = ()>;
    ...
    fn set_protocol(&mut self, protocol: hid::Protocol) -> impl core::future::Future<Output = ()>;
    ...
    fn vendor_cmd(&mut self) -> impl core::future::Future<Output = ()>;
