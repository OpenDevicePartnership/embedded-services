...
pub async fn rx_task<T: TemperatureSensor + TemperatureThresholdSet>(sensor: &'static Sensor<T>) {
...
pub async fn sample_task<T: TemperatureSensor + TemperatureThresholdSet>(sensor: &'static Sensor<T>) {
...
pub async fn alert_task<T: TemperatureSensor + TemperatureThresholdSet, A: embedded_hal_async::digital::Wait>(
