...
impl<T: Controller> Sensor<T> {
    ...
    async fn check_thresholds(&self, temp: DegreesCelsius) {
        ...
        } else if temp < self.profile.lock().await.warn_high_threshold {
        ...
        } else if temp > self.profile.lock().await.warn_low_threshold {
        ...
        } else if temp < self.profile.lock().await.prochot_threshold {
        ...
        } else if temp < self.profile.lock().await.crt_threshold {
