...
impl Default for CfuComponentDefault {
    fn default() -> Self {
        Self::new(1, false, None)
    }
}

impl CfuDeviceContainer for CfuComponentDefault {
    fn get_cfu_component_device(&self) -> &CfuDevice {
        &self.device
    }
}

impl CfuComponentDefault {
    /// Constructor
    pub fn new(
        id: ComponentId,
        is_primary: bool,
    ...
    pub async fn process_request(&mut self) -> Result<(), CfuError> {
...
impl CfuComponentInfo for CfuComponentDefault {
...
impl CfuComponentStorage for CfuComponentDefault {
...
impl CfuComponentTraits for CfuComponentDefault {}
...
pub struct CfuWrapperDefault<C: CfuComponentTraits + CfuDeviceContainer> {
    /// internal reference to the component
    pub component: RefCell<C>,
}

impl<C: CfuComponentTraits + CfuDeviceContainer> CfuWrapperDefault<C> {
    /// Constructor
